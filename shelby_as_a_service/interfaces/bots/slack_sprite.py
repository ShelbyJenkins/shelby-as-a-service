...
class SlackSprite:
    ...
    def __init__(self, config_file_dict={}, **kwargs):
        ...
        #     level="INFO",
        # )
        # self.log.info("Starting SlackSprite.")
        ...
        async def query_command(ack, body):
            ...
            if moniker_instance is None:
                self.log.info(f"Something went wrong loading the team {body['team_id']} for SlackSprite")
            ...
            if isinstance(request_response, dict) and "answer_text" in request_response:
                ...
                # log_agent.info(f'Error: {request_response})')
        ...
        async def bot_mention(ack, event):
            ...
            if moniker_instance is None:
                self.log.info(f"Something went wrong loading the team {event['team']} for SlackSprite")
    ...
    def find_moniker_instance(self, team):
        ...
        self.log.info(f"No matching moniker found for {team}")
        return None
