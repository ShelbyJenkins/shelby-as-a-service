...
import sprites.local.gradio_interface as Interface
# endregion

class LocalSprite(AppBase):
    
    sprite_name="local_sprite"
    ...
    def __init__(self, app: AppBase = None):
        ...
        AppBase.config_manager.setup_service_config(self)

    
        self.ceq_agent = CEQAgent(self)
        self.vanilla_agent = VanillaChatAgent(self)

        self.existing_app_names_ = self.app_manager.check_for_existing_apps()
    ...
    def run_sprite(self):
       Interface.create_interface(self)
