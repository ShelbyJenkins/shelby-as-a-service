...
def check_url_input(chat_tab_url_text, web_tab_url_text):
    ...
    chat_tab_valid = is_valid_url(chat_tab_url_text)
    web_tab_valid = is_valid_url(web_tab_url_text)
    if chat_tab_valid and web_tab_valid:
        gr.Warning("Using URL from web_tab_url_text")
        return web_tab_url_text
    elif chat_tab_valid:
        return chat_tab_url_text
    elif web_tab_valid:
        return web_tab_url_text
    else:
