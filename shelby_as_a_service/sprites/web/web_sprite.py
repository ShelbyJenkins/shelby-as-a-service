...
from sprites.web.gradio_events import GradioEvents
from sprites.web.gradio_themes import AtYourServiceTheme
from sprites.web.ui_chat import UIChat
from sprites.web.ui_settings import UISettings
...
class WebSprite(SpriteBase):
    ...
    class SpriteConfigModel(BaseModel):
        ...
        current_feature_ui_name: str = "VanillaLLM Agent"
    ...
    def __init__(self):
        ...
        self.ui = {}
        self.ui["ui_shared"] = {}
        self.ui["ui_shared"]["update_settings_file"] = gr.State(False)
        self.ui["features"] = {}
    ...
    def run_chat(
        ...
        agent = self.get_selected_agent(self.config.current_feature_ui_name)
        if agent is None:
